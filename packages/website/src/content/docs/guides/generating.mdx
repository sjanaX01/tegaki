...
The Tegaki generator processes Google Fonts through a multi-stage pipeline to produce stroke data suitable for handwriting animation. Use the [interactive generator](/tegaki/generator/) on the Tegaki website to generate font bundles directly in the browser.
